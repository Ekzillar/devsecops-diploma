...
Инструмент: OWASP ZAP в режиме baseline-сканирования.
...
Результаты: после каждого деплоя автоматически выполняется сканирование. Отчёт доступен во вкладке Actions (артефакты). Пример найденных предупреждений (уровня Medium/Low):
