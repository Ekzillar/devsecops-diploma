...
Вот отличный вариант для раздела **Этап 2: SAST** в ваш `README.md`. Он краткий, информативный и полностью соответствует критериям диплома (описание выбора инструмента, результат, ссылка на артефакты).
